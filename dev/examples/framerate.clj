       ...
       [ui/rect {:paint (paint/fill 0xFF0D1924)}
        [ui/with-context {:fill-text fill-text
         ...
         [ui/padding {:padding 20}
          (let [gap   10
                table [[[ui/halign {:position 0.5} [ui/valign {:position 1} [ui/gap]]]
                        [ui/halign {:position 0.5} [ui/valign {:position 1} [ui/label "15 fps"]]]
                        [ui/halign {:position 0.5} [ui/valign {:position 1} [ui/label "30 fps"]]]
                        [ui/halign {:position 0.5} [ui/valign {:position 1} [ui/label "60 fps"]]]
                        [ui/halign {:position 0.5} [ui/valign {:position 1} [ui/label "120 fps"]]]]
                       [[ui/halign {:position 1} [ui/valign {:position 0.5} [ui/label "No interpolation"]]]
                        [panel :no 15]
                        [panel :no 30]
                        [panel :no 60]
                        [panel :no 120]]
                       [[ui/halign {:position 1} [ui/valign {:position 0.5} [ui/label "Motion blur"]]]
                        [panel :blur 15]
                        [panel :blur 30]
                        [panel :blur 60]
                        [panel :blur 120]]
                       [[ui/halign {:position 1} [ui/valign {:position 0.5} [ui/label "In-betweens"]]]
                        [panel :inbetweens 15]
                        [panel :inbetweens 30]
                        [panel :inbetweens 60]
